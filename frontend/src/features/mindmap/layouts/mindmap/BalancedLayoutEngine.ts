 ...
 */
export class BalancedLayoutEngine extends BaseLayoutEngine {
  readonly id = 'balanced';
  readonly name = 'layouts.balanced';
  readonly nameEn = 'layouts.balanced';
  readonly description = 'layouts.balancedDesc';
  ...
  calculate(
    ...
    // 根到一级为 scale(0)=1，层距保持基准 horizontalGap 不收敛
    if (left.length > 0) {
